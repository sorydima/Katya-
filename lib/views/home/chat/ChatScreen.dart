...
import 'package:katya/domain/crypto/events/actions.dart';
import 'package:katya/domain/crypto/events/selectors.dart';
...
import 'package:katya/domain/media/filters.dart';
...
import 'package:katya/views/home/chat/widgets/ChatInput.dart';
import 'package:katya/views/home/chat/widgets/MessageList.dart';
...
class ChatScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final chatColorPrimary = useSelector<AppState, Color>(
      ...
      const Color(AppColors.cyankatya),
    );
