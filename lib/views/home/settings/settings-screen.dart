...
class SettingsScreen extends StatelessWidget {
  ...
  dynamic onToggleAccountBottomSheet(BuildContext context, _Props props) {
  ...
  Future onLogout(BuildContext context, _Props props) {
  ...
  void onNavigatePrivacySettings(BuildContext context) {
