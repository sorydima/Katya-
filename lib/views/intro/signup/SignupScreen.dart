...
import 'package:katya/views/intro/signup/widgets/StepCaptcha.dart';
import 'package:katya/views/intro/signup/widgets/StepEmail.dart';
import 'package:katya/views/intro/signup/widgets/StepTerms.dart';
...
class SignupScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hostname = useSelector<AppState, String>((state) => state.authStore.hostname, 'matrix.katya.wtf');
      ...
      switch (currentSection.runtimeType) {
        ...
        case TermsStep:
          return () async {
            ...
            // If the user has a completed auth flow for matrix.katya.wtf, reset to
