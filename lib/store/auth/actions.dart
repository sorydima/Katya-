...
import 'package:katya/global/libs/matrix/utils.dart';
...
import 'package:katya/store/auth/homeserver/actions.dart';
  ...
  return (Store<AppState> store) async {
    ...
    try {
      ...
      store.dispatch(addAlert(
        origin: 'fetchHomeserver',
        message:
            'Having trouble connecting to this Katya ® 👽 AI 🧠 REChain 🪐 Blockchain Node, try again later or pick another Node.',
        error: error,
      ));
    }
