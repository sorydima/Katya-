...
/// Мост для Microsoft Teams
class TeamsBridge extends MessengerBridge {
  @override
  MessengerType get messengerType => MessengerType.teams;
  ...
  Future<void> initialize() async {
    log.info('Initializing Microsoft Teams bridge...');
  }

  @override
  Future<bool> connect(MessengerConnection connection) async {
    log.info('Connecting to Microsoft Teams for user: ${connection.username}');
    return true;
  }

  @override
  Future<void> disconnect(MessengerConnection connection) async {
    log.info('Disconnecting from Microsoft Teams');
  }

  @override
  Future<bool> sendMessage(MessengerMessage message) async {
    log.info('Sending Microsoft Teams message: ${message.content}');
    return true;
  }
