...
/// Мост для Skype
class SkypeBridge extends MessengerBridge {
  @override
  MessengerType get messengerType => MessengerType.skype;
  ...
  Future<void> initialize() async {
    log.info('Initializing Skype bridge...');
  }

  @override
  Future<bool> connect(MessengerConnection connection) async {
    log.info('Connecting to Skype for user: ${connection.username}');
    return true;
  }

  @override
  Future<void> disconnect(MessengerConnection connection) async {
    log.info('Disconnecting from Skype');
  }

  @override
  Future<bool> sendMessage(MessengerMessage message) async {
    log.info('Sending Skype message: ${message.content}');
    return true;
  }
