...
uninstall: 
	adb shell && pm uninstall com.katya.wtf # (sometimes doesn't uninstall when debugging?)
format: 
...
inspect-android: 
	adb shell && run-as com.katya.wtf # cache inspection
log-android: 
...
init-platform-dirs: 
	flutter create --com com.katya.wtf
enable-desktop: 
